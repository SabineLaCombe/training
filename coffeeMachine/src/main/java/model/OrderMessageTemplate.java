...
public class OrderMessageTemplate {
    ...
    public static final String SHORTAGE_MESSAGE = "Sorry, the drink cannot be delivered because of shortages of water and/or milk. A notification has been sent to the person in charge.";
